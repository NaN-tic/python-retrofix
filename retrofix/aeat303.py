...
RECORD = (
    ...
    (859, 1, 'payment_type', Numeric(sign=SIGN_N)),
    (860, 17, 'payment_amount', Numeric(sign=SIGN_N)),
    (877, 20, 'payment_bank_account', Char),
    (897, 1, 'complementary_autoliquidation', Numeric(sign=SIGN_N)),
    (898, 17, 'previous_declaration_receipt', Numeric(sign=SIGN_N)),
    (911, 1, 'joint_presentation_allowed', Char),
    (912, 1, 'auto_bankruptcy_declaration', Char),
    (913, 398, 'reserved', Char),
    (1311, 16, 'signature_city', Numeric(sign=SIGN_N)),
