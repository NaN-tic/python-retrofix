...
GENERAL_RECORD = (
    ...
    (  63, 17, 'not_subject_localization_rules', Numeric(sign=SIGN_N)),
    (  80, 17, 'reserved_aeat1', Numeric(decimals=0, sign=SIGN_POSITIVE)),
    (  97, 17, 'subject_operations_w_reverse_charge', Numeric(sign=SIGN_N)),
    ( 114, 17, 'oss_not_subject_operations', Numeric(sign=SIGN_N)),
    ( 131, 17, 'oss_subject_operations', Numeric(sign=SIGN_N)),
    ...
    ( 272, 17, 'aduana_tax_pending', Numeric(sign=SIGN_POSITIVE)),
    ( 289, 17, 'previous_period_pending_amount_to_compensate',
        Numeric(sign=SIGN_POSITIVE)),
    ( 306, 17, 'previous_period_amount_to_compensate', Numeric(
            sign=SIGN_POSITIVE)),
    ...
    ( 468, 17, 'reserved_aeat2', Char),
    ( 485, 70, 'return_bank_name', Char),
    ( 555, 35, 'return_bank_address', Char),
    ( 590, 30, 'return_bank_city', Char),
    ( 620,  2, 'return_bank_country_code', Char),
    ( 622,  1, 'return_sepa_check', Char),
    ( 623,445, 'reserved_aeat3', Char),
...
ADDITIONAL_RECORD = (
    ...
    ( 171, 17, 'annual_subject_operations_w_reverse_charge',
        Numeric(sign=SIGN_N)),
    ( 188, 17, 'annual_oss_not_subject_operations', Numeric(sign=SIGN_N)),
    ( 205, 17, 'annual_oss_subject_operations', Numeric(sign=SIGN_N)),
    ( 222, 17, 'annual_intragrup_transaction', Numeric(sign=SIGN_N)),
